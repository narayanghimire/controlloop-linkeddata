...
void setup() {
  ...
  if (client.connect(buf, 8080)) {
    ...
    // Make a HTTP request:
    String prefix = "@prefix ssn: <http://purl.oclc.org/NET/ssnx/ssn#> .";
    String triple1 = "<> ssn:isProducedBy <http://scc-cnor-129py5.scc.kit.edu:8080/marmotta/ldp/ldbc/SensorPart/90-A2-DA-10-BB-B7>; ";
    String triple2 = " ssn:hasValue <http://scc-cnor-129py5.scc.kit.edu:8080/marmotta/ldp/ldbc/SensorPart/TempValue/ObservationValue> ; a ssn:SensorOutput . ";
    String content = prefix + triple1 + triple2;
    client.println(F("POST /marmotta/ldp/ldbc/SensorPart/TempValue HTTP/1.1")); 
    ...
    client.println(F("Slug: SensorOutput"));
